...
export const BREADCRUMBS_STUDENT_RECORD = "Dzienniczek";
export const MENU_ITEM_CALENDAR = "Kalendarz";
export const MENU_ITEM_REGISTRATION = "Rejestracja";
export const MENU_ITEM_USERS = "Użytkownicy";
...
export const STUDENT_RECORD_MODULE_URL = "http://www.intive-patronage.pl:90/";
...
export const HOME_TITLE = "Dzienniczek";
export const HOME_INFO = "Poniżej wylistowani zostali uczestnicy procesu kwalifikacyjnego programu Intive Patronage wraz z ich średnimi ocenami uzyskanymi za zadania kwalifikacyjne.";
export const HOME_SHOW_INACTIVE_CHECKBOX_LABEL = "Pokaż również nieaktywnych";
